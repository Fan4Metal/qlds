...
Если хочешь собирать движок + minqlx сам (пины версий, компактнее образ), есть
...
Пины версий (базовый образ, minqlx, плагины) — вверху Dockerfile. Учти: свой
образ надо пересобирать под апдейты QL/minqlx, и перед боевым использованием
